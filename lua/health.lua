 ...
 local function spaces(amount) _G.assert((nil ~= amount), "Missing argument amount on /home/lain/.config/nvim/fnl/modules/tools/eval/config.fnl:8")
 ...
 local function report_21(name, max_name_length) _G.assert((nil ~= max_name_length), "Missing argument max-name-length on /home/lain/.config/nvim/fnl/modules/tools/eval/config.fnl:12") _G.assert((nil ~= name), "Missing argument name on /home/lain/.config/nvim/fnl/modules/tools/eval/config.fnl:12")
